...
{
       0,    38,    38,    41,    43,    45,    48,    52,    54,    56,
      59,    72,    85,    86,    88,    90,   108,   119,   129,   143,
     157,   163,   176,   177,   180,   181,   184,   189,   195,   197,
     199,   201,   203,   205,   215,   217,   227,   229,   231,   233
};
#endif
...
/* Line 1455 of yacc.c  */
#line 197 "program.y"
    {  int i = number_for_key2((yyvsp[(1) - (1)].string));  (yyval.number) = sym[i].n; printf("Variable value: %d",(yyval.number));}
    break;
